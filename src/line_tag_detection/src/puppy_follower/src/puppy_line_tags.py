...
def run(img):
    global draw_color, line_centerx, __target_color , flag, zoom
    size = (320, 240)
    # size = (640, 480)
    img_copy = img.copy()
...
def image_callback(ros_image):
    ...
    if zoom:
        frame_result = digital_zoom(frame_result,2)
